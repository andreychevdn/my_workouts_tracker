...
const CalendarBody = (props) => {
    ...
    const { firstDayOfMonth, daysInMonth, currentDay, 
            currentMonth, currentMonthNum, selectedDay,
            activeDays, setSelectedDay, actualMonth, weekdays } = props;
    ...
    for (let d = 1; d <= daysInMonth(); d++) {
        ...
        let formattedDate = `${d}-${currentMonthNum() +1}`;
